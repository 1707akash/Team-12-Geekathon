A basic todo list web app resembling Trello. Features drag-and-drop tasks, task organization, priority levels, deletion, and local storage. Built with HTML, CSS, JavaScript.
